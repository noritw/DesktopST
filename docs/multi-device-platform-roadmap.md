...
> 狀態：**A／B1／B2／B2.7 完成，`mobile.html` 對照清單完成；下一步是 B2.5 Lorebook core**
...
> ## 👉 現在的下一步是 **B2.5 Lorebook core**（B3 前最後一項）
>
...
> | 4 | **B2.5 Lorebook core（3–5 天）** | ⬜ **下一步**。擋 B3（手機 UI 要有東西可接）|
> | 5 | B2.6 Lorebook 桌面 UI | ⬜ owner 決議現在做（不擋 B3）|
