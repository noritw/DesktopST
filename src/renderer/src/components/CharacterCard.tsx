...
export default function CharacterCard({ character, isOnDesktop, onClick, onContextMenu, onSummonToDesktop }: Props) {
  ...
  return (
    <div className="relative flex h-[160px] min-w-[120px] flex-col rounded-2xl border border-border bg-white/90 shadow-soft transition-transform hover:scale-[1.02] hover:border-teal/40">
      <button
        type="button"
