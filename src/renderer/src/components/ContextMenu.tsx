...
export default function ContextMenu({
  ...
  if (deleteConfirm) {
    return (
      <div id={`ctx-${characterId}`} style={style} className="rounded-2xl border border-border bg-surface shadow-soft p-3 w-[220px] space-y-2">
  ...
  return (
    <div id={`ctx-${characterId}`} style={style} className="rounded-2xl border border-border bg-surface shadow-soft overflow-hidden min-w-[184px]">
      <button
        type="button"
